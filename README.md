...
La balance s'appuie sur une **cellule de charge** associée à un **convertisseur/amplficateur HX711**, l'ensemble étant relié à un **ESP32**. L'exploitation du système, à l'__exception__ de la **tare qui est effectuée directement via la console série**, est réalisée sur une **interface Node-RED**.
