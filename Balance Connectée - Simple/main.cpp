...
if (scale.is_ready()) { // si HX711 prêt
    ...
    float u_m1 = 0; // relatif à l'incertitude d'étalonnage (classée)

    float u_m2 = 0; // relatif à l'incertitude d'étalonnage (tolérée)
    float erreur = 0; // relatif à l'erreur (tolérée)
    float u_et = 0;  // relatif à l'incertitude ... (tolérée)
...
/////////////////////////////             1g             //////////////////////////////////////////////////////////////////////////////////
    ...
    // masse étalonnée 
      ...
      u_et = 0.021842264; // incertitude étalonnage
...
/////////////////////////////             2g             //////////////////////////////////////////////////////////////////////////////////
    ...
    // masse étalonnée 
      ...
      u_et = 0.022079462; // incertitude étalonnage
      u_m2= sqrt(pow(u_et, 2) + pow(u_r, 2) + pow(u_j, 2));
      incert_2 = 2 * u_m2;
      client.publish(topic_incert_2, String(incert_2, 3).c_str()); // Publication de l'incertitude "étalonnée" sur le topic
...
/////////////////////////////             5g             //////////////////////////////////////////////////////////////////////////////////
    ...
    // masse étalonnée 
      ...
      u_et = 0.022776294; // incertitude étalonnage
      u_m2 = sqrt(pow(u_et, 2) + pow(u_r, 2) + pow(u_j, 2));
      incert_2 = 2 * u_m2;
      client.publish(topic_incert_2, String(incert_2, 3).c_str()); // Publication de l'incertitude "étalonnée" sur le topic
...
/////////////////////////////             10g             //////////////////////////////////////////////////////////////////////////////////
    ...
    // masse étalonnée 
      ...
      u_et = 0.023892814; // incertitude étalonnage
      u_m2 = sqrt(pow(u_et, 2) + pow(u_r, 2) + pow(u_j, 2));
      incert_2 = 2 * u_m2;
      client.publish(topic_incert_2, String(incert_2, 3).c_str()); // Publication de l'incertitude "étalonnée" sur le topic
...
/////////////////////////////             20g             //////////////////////////////////////////////////////////////////////////////////
    ...
    // masse étalonnée 
      ...
      u_et = 0.025983158; // incertitude étalonnage
      u_m2 = sqrt(pow(u_et, 2) + pow(u_r, 2) + pow(u_j, 2));
      incert_2 = 2 * u_m2;
      client.publish(topic_incert_2, String(incert_2, 3).c_str()); // Publication de l'incertitude "étalonnée" sur le topic
...
/////////////////////////////             50g             //////////////////////////////////////////////////////////////////////////////////
    ...
    // masse étalonnée 
      ...
      u_et = 0.03143654; // incertitude étalonnage
      u_m2 = sqrt(pow(u_et, 2) + pow(u_r, 2) + pow(u_j, 2));
      incert_2 = 2 * u_m2;
      client.publish(topic_incert_2, String(incert_2, 3).c_str()); // Publication de l'incertitude "étalonnée" sur le topic
    }
...
/////////////////////////////             100g             //////////////////////////////////////////////////////////////////////////////////
    ...
    // masse étalonnée 
      ...
      u_et = 0.038876062; // incertitude étalonnage
      u_m2 = sqrt(pow(u_et, 2) + pow(u_r, 2) + pow(u_j, 2));
      incert_2 = 2 * u_m2;
      client.publish(topic_incert_2, String(incert_2, 3).c_str()); // Publication de l'incertitude "étalonnée" sur le topic
    }
...
/////////////////////////////             200g             //////////////////////////////////////////////////////////////////////////////////
    ...
    // masse étalonnée 
      ...
      u_et = 0.050616699; // incertitude étalonnage
      u_m2 = sqrt(pow(u_et, 2) + pow(u_r, 2) + pow(u_j, 2));
      incert_2 = 2 * u_m2;
      client.publish(topic_incert_2, String(incert_2, 3).c_str()); // Publication de l'incertitude "étalonnée" sur le topic
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    client.publish(topic_temp, String(temp).c_str()); // Publication de la température sur le topic
